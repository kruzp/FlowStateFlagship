...
import vorticityFrag from './shaders/curl.frag.glsl?raw';
import confinementFrag from './shaders/vorticityConfinement.frag.glsl?raw';
...
export class Simulation {
   ...
   * pipeline (Stam; Fedkiw et al.'s vorticity confinement).
   */
  step(deltaTime: number): void {
    ...
    if (this.config.ambientStrength > 0) {
