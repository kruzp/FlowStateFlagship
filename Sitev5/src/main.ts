...
const revealTargets = document.querySelectorAll(
  '.section__title, .services__intro, .systemsGrid__item, .pillars__item, .pricing__intro, .priceCard, .pricingDivider, .addonCard, .pricing__footnote, .why__principle, .contact__body, .contact__email, .contact__meta, .faqItem',
);
